    ...
    <div className="relative overflow-hidden pt-20">
      ...
      <section className="relative min-h-screen flex items-center justify-center pt-10 px-6 sm:px-12" onMouseMove={handleMouseMove}>
        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <div className="absolute inset-0 bg-gradient-to-br from-[var(--color-brand-dark)] via-[var(--color-brand-gray)] to-[var(--color-brand-dark)]" />

          <motion.div
            style={{ x: springX, y: springY }}
            className="absolute top-1/4 right-1/4 w-[600px] h-[600px] bg-gradient-to-br from-[var(--color-brand-orange-primary)]/10 to-[var(--color-brand-orange-secondary)]/5 blur-[120px] clip-angular-sm"
          />
          <motion.div
            style={{ x: -springX, y: -springY }}
            className="absolute bottom-1/4 left-1/4 w-[500px] h-[500px] bg-gradient-to-br from-brand-red/5 to-[var(--color-brand-orange-primary)]/10 blur-[100px] clip-angular-sm"
          />
        ...
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-16 items-center relative z-10 text-center lg:text-left">
          ...
          >
            ...
            <motion.div
              ...
              className="inline-flex items-center gap-2 px-6 py-2.5 clip-angular-sm bg-gradient-to-r from-[var(--color-brand-orange-primary)]/10 to-[var(--color-brand-orange-secondary)]/10 border border-[var(--color-brand-orange-primary)]/20 text-xs font-bold tracking-widest uppercase mb-8 backdrop-blur-xl"
            >
            ...
            >
              ...
              >
                <div className="absolute inset-0 bg-gradient-to-r from-[var(--color-brand-orange-primary)] to-[var(--color-brand-orange-secondary)]" />
              ...
              >
                ...
                <div className="relative backdrop-blur-xl bg-gradient-to-br from-white/10 to-white/5 p-8 clip-angular-md border border-white/10 hover:border-white/20 transition-all duration-300">
                  ...
                  <motion.div
                    ...
                    viewport={{ once: true }}
                    className="w-12 h-12 mx-auto mb-6 bg-gradient-to-br from-[var(--color-brand-orange-primary)]/20 to-[var(--color-brand-orange-secondary)]/20 clip-angular-sm flex items-center justify-center border border-[var(--color-brand-orange-primary)]/20"
                  >
                    <stat.icon className="w-6 h-6 text-[var(--color-brand-orange-primary)]" />
                  </motion.div>
                  ...
                  {/* Hover Glow */}
                  <div className="absolute inset-0 bg-gradient-to-br from-[var(--color-brand-orange-primary)]/0 to-[var(--color-brand-orange-secondary)]/0 group-hover:from-[var(--color-brand-orange-primary)]/10 group-hover:to-[var(--color-brand-orange-secondary)]/10 clip-angular-md transition-all duration-300 -z-10" />
                </div>
              </motion.div>
            ))}
          </div>
          ...
          <div className="flex flex-col md:flex-row md:items-end justify-between mb-20 gap-8">
            ...
            >
              <motion.div
                ...
                viewport={{ once: true }}
                className="inline-flex items-center gap-2 px-4 py-2 clip-angular-sm bg-gradient-to-r from-[var(--color-brand-orange-primary)]/10 to-[var(--color-brand-orange-secondary)]/10 border border-[var(--color-brand-orange-primary)]/20 text-xs font-bold tracking-widest uppercase mb-6 backdrop-blur-xl"
              >
              ...
              >
                ...
                <div className="relative backdrop-blur-2xl bg-gradient-to-br from-white/10 to-white/5 p-8 clip-angular-lg border border-white/10 hover:border-white/20 transition-all duration-500 overflow-hidden">
                  ...
                  <Link
                    ...
                    className="inline-flex items-center gap-2 text-sm font-bold text-[var(--color-brand-orange-primary)] transition-all relative z-10 group-hover:text-[var(--color-brand-orange-secondary)]"
                  >
          ...
          <div className="relative p-1 rounded-[56px] bg-gradient-to-br from-[var(--color-brand-orange-primary)]/20 to-[var(--color-brand-orange-secondary)]/20">
            <div className="relative overflow-hidden rounded-[52px] bg-gradient-to-br from-[var(--color-brand-gray)] to-[var(--color-brand-dark)] p-12 md:p-20 text-center border border-white/10">
              ...
              <motion.div
                ...
                className="absolute top-0 right-1/4 w-96 h-96 bg-gradient-to-br from-[var(--color-brand-orange-primary)]/20 to-[var(--color-brand-orange-secondary)]/20 blur-[100px] clip-angular-sm"
              />
              <motion.div
                animate={{
                  scale: [1, 1.3, 1],
                ...
                className="absolute bottom-0 left-1/4 w-96 h-96 bg-gradient-to-br from-brand-red/15 to-[var(--color-brand-orange-primary)]/20 blur-[100px] clip-angular-sm"
              />
