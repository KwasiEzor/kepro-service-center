...
router.patch('/quotes/:id/status',
  authenticate,
  requireAdmin,
  validateParams(z.object({ id: z.string().max(100) })),
  validateBody(z.object({ status: z.string().max(50), adminNotes: z.string().max(5000).optional(), estimatedPrice: z.coerce.number().optional() })),
...
router.patch('/contacts/:id/status',
  ...
  requireAdmin,
  validateParams(z.object({ id: z.string().max(100) })),
  validateBody(z.object({ status: z.string().max(50), adminReply: z.string().max(5000).optional() })),
...
router.delete('/images/:id', authenticate, requireAdmin, validateParams(z.object({ id: z.string().max(100) })), (req, res, next) => adminController.deleteImage(req, res, next));
...
router.patch('/services/:id', authenticate, requireAdmin, validateParams(z.object({ id: z.string().max(100) })), validateBody(serviceSchema.partial()), (req, res, next) => adminController.updateService(req, res, next));
router.delete('/services/:id', authenticate, requireAdmin, validateParams(z.object({ id: z.string().max(100) })), (req, res, next) => adminController.deleteService(req, res, next));
...
router.patch('/faqs/:id', authenticate, requireAdmin, validateParams(z.object({ id: z.string().max(100) })), validateBody(faqSchema.partial()), (req, res, next) => adminController.updateFAQ(req, res, next));
router.delete('/faqs/:id', authenticate, requireAdmin, validateParams(z.object({ id: z.string().max(100) })), (req, res, next) => adminController.deleteFAQ(req, res, next));
...
router.get('/invoices/:id', authenticate, requireAdmin, validateParams(z.object({ id: z.string().max(100) })), (req, res, next) => adminController.getInvoice(req, res, next));
router.post('/invoices/from-quote/:quoteId',
  authenticate,
  requireAdmin,
  validateParams(z.object({ quoteId: z.string().max(100) })),
  validateBody(z.object({
...
router.delete('/invoices/:id', authenticate, requireAdmin, validateParams(z.object({ id: z.string().max(100) })), (req, res, next) => adminController.deleteInvoice(req, res, next));
